    ...
    return (
            <div className={"productDetail__margin"}>
                ...
                <div className={"productDetails__count-button"}><Button type="primary"
                    ...
                    <Input className={"productDetails__input"} value={count + " " + productDetails.unit_type}/><Button
            ...
            <div className={"productDetails__text"}>
                ...
                <Input className={"productDetails__addcomment"} value={commentText} onChange={changeCommentText} size={"large"}
                ...
                <Button className={"productDetails__addcomment--button"}  type={"primary"} disabled={addButtonSt}
                        onClick={() => addComment(user.id, commentText, productDetails.id,fullname)}>добавить комментарий</Button>
            </div>
                </div>
